...
public class FileManagerTest {
    ...
    public void readsLines1() throws FileNotFoundException {
        ...
        tekstit.add("eka");
        tekstit.add("toka");
        rivienLuku(tekstit, "src/main/java/testinput1.txt", "src/test/java/tmp/testinput1.txt");
    }
    ...
    public void readsLines2() throws FileNotFoundException {
        ...
        rivienLuku(tekstit, "src/main/java/testinput2.txt", "src/test/java/tmp/testinput2.txt");
    }
    ...
    private void rivinTallennus(FileManager t, String teksti) throws IOException, FileNotFoundException {
        ...
        String tdsto = "src/test/java/tmp/tmp" + arvottu + ".txt";
        t.save(tdsto, teksti);
